...
monthlyTransactionsFile = "./files/InternalAuditPcardPreviousMonth_MonthlywGLInternalAudit_20240305064658.xlsx" # Feb 24 File
...
pivotMappingFile = "./files/Go Prama Master- PCard-Mappings-Consolidated-03232024.xlsx"
# %%
...
con.sql(
    f"""CREATE TABLE pivot_mapping AS SELECT * FROM st_read('{pivotMappingFile}', layer = 'Final Mapping', open_options=['HEADERS=FORCE']);"""
)
...
df.to_excel("./files/pcard_monthly_output_full-new1.xlsx")
