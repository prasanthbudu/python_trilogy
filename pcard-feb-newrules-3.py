...
con.sql("""
UPDATE clean_transactions_3 SET ALL_MATCHED_RULES = ALL_MATCHED_RULES || 'RULE2 ' WHERE RULE2_2SAMEVENDOR = True
""")
...
con.sql("""
UPDATE clean_transactions_3 SET ALL_MATCHED_RULES = ALL_MATCHED_RULES || 'RULE4 ' WHERE RULE4_SAMEDOLLAR = True
""")
